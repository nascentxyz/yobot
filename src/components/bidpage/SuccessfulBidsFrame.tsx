...
const SuccessfulBidsFrame = () => {
  ...
  return (
    <BidBox>
      <SuccessfulBidText>{t("Successful Bids")}</SuccessfulBidText>
      <CustomTable size="sm">
        <Thead>
          <Tr>
            <Th>{t("")}</Th>
...
const SuccessfulBidText = styled.p`
  height: auto;
...
export default SuccessfulBidsFrame;
